...
public class HelperShoot : MonoBehaviour
{
    ...
    {
        enemy = GameObject.FindGameObjectWithTag("Enemy");
        Vector3 difference = enemy.transform.position - shotPosition.transform.position;
        ...
        var currentDistance = Vector3.Distance(enemy.transform.position, transform.position);
